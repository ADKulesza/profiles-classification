...
def barh_plot(density_list, colors, order, metric, labels_y, grid, plt_prop, output_dir):
...
def process(paths, order, grid=False):
    ...
    for metric in metrics_list:
        ...
        barh_plot(m_values, colors, order, metric, labels_y, grid, plt_prop, paths.output_dir)
